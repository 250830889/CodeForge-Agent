"""Skills system — discover and execute .codeforge/skills/*/SKILL.md prompts."""
...
def resolve_skill_prompt(skill: SkillDefinition, args: str) -> str:
    ...
    prompt = prompt.replace("${CODEFORGE_SKILL_DIR}", skill.skill_dir)
    return prompt
